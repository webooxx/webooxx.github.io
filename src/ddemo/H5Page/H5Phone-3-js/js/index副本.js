...
var addClass = function (element , _className) {
  ...
  var classNameMap = {}
          ...
          for(var i=0;i<classname.length;i++){ 100="" 基本代码，需要优化="" classnamemap[="" classname[i]]="1;" }="" classnamemap[_classname]="1;" classname="[];" for(i="" in="" classnamemap){="" classname.push(i);="" element.classname="className.join('" ');="" +="('" '+classname="" );="" 错误示例="" var="" removeclass="function" (element="" ,="" _classname)="" {="" classnamemap="{}" for(var="" i="0;i<className.length;i++){" delete="" classnamemap[_classname];="" settimeout(function="" ()="" {getbyclass('screen-1__subheading')[0].style.opacity="1;},1000);" window.onscroll="function" top="document.body.scrollTop;" 顶部菜单栏的设置="" if(="" <="" ){="" removeclass(="" getbyclass('header')[0]="" 'header_status_white'="" getbyclass('outline')[0].style.opacity="0;" }else{="" addclass(="" )="" ;="" mouseentertip(getbyclass('header__nav-item')[0]);="" 第二屏的初始设置="" getbyclass('screen-2__subheading')[0].style.opacity="0;" getbyclass('screen-2__tip')[0].style.opacity="0;" getbyclass('screen-2__sub-1')[0].style.opacity="0;" getbyclass('screen-2__sub-2')[0].style.opacity="0;" 滚动后第二屏幕的设置="" if(top=""> 340){
