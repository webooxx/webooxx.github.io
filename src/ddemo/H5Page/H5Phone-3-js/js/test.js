...
(()=>{
  ...
  document.getElementsByClassName('screen-1')[0].onclick =function() {
    for(var i=0;i<test.length;i++){ test[i]['elem'].setattribute('class',="" init="" ?="" test[i]['init']="" :="" test[i]['done']="" );="" }="" })();="" 屏幕1测试动画="" (()="">{
          var test = 
          [
          {
          ...
          document.getElementsByClassName('screen-2')[0].onclick =function() {
            for(var i=0;i<test.length;i++){ test[i]['elem'].setattribute('class',="" init="" ?="" test[i]['init']="" :="" test[i]['done']="" );="" }="" })();="" 屏幕2测试动画="" (()="">{
          var test = 
          [
          {
          ...
          document.getElementsByClassName('screen-3')[0].onclick =function() {
            for(var i=0;i<test.length;i++){ test[i]['elem'].setattribute('class',="" init="" ?="" test[i]['init']="" :="" test[i]['done']="" );="" }="" })();="" 屏幕3测试动画="" (()="">{
          var test = 
          [
          {
          ...
          document.getElementsByClassName('screen-4')[0].onclick =function() {
            for(var i=0;i<test.length;i++){ test[i]['elem'].setattribute('class',="" init="" ?="" test[i]['init']="" :="" test[i]['done']="" );="" }="" })();="" 屏幕4测试动画="" (()="">{
          var test = 
          [
          {
          ...
          document.getElementsByClassName('screen-5')[0].onclick =function() {
            for(var i=0;i<test.length;i++){ test[i]['elem'].setattribute('class',="" init="" ?="" test[i]['init']="" :="" test[i]['done']="" );="" }="" })();="" 屏幕5测试动画="" (()="">{
          var test = 
          [
        ...
        })(); // 菜单栏动画切换</test.length;i++){></test.length;i++){></test.length;i++){></test.length;i++){></test.length;i++){>