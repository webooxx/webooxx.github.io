...
this.redraw = function (_i) {
    ...
    if (this.lastRedraw === _i) { // <<<<< 自身没有变化就不操作 return="" this;="" }="" this.lastredraw="_i;" var="" i="_i" ||="" 0;="" s="this.src[i].cns;" w="this.w" (s.width="" );="" h="this.h" (s.height="" if="" (this.config.isfull)="" {="" gcns="this.game.cns;" gcns.height);="" this.w="this.ctx.width" =="" this.cns.width="w;" this.h="this.ctx.height" this.cns.height="h;" this.ctx.drawimage(s,="" 0,="" w,="" h);="" this.bg();="" 绘制自身到场景中="" this.drawtoscene="function" ()="" scene="this.game.ctx;" (this.visible)="" scene.drawimage(this.cns,="" this.x,="" this.y,="" *="" this.zoom,="" this.zoom);="" js="" game.component.redraw.js="" <<<<<="" this.bg="function" (c)="" this.ctx.fillstyle="c" 'rgba(255,0,0,.1)';="" this.ctx.fillrect(0,="" this.w,="" this.h);="" 清理自身="" this.clean="function" this.ctx.clearrect(0,="" 99999,="" 99999);="" ---="" 简单动画="" 播放自身的动画="" this.play="function" (_config)="" fn="{" start:="" function="" (context)="" context.max="context.config.max" this.src.length;="" context.idx="context.config.idx" },="" run:="" this.redraw(context.idx);="" context.idx++;="" isover:="">= context.max;
            }
        };
