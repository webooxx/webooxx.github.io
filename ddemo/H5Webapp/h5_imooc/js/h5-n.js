...
$(function(){
	...
	ppt
		...
		.addPage()
			.addComponent('caption',{text:'HTML/CSS/JS代码量'})
			.addComponent('pie',{
				type:'pie',
				data:[
					['HTML',.08,'green'],
			...
			.addComponent('msg',{
				text:'总代码行数1439，其中 html/css/js 各为 118/915/406',
				css:{opacity:0,bottom:80,textAlign:'center',width:'100%'},
				animateIn:{opacity:1},
				animateOut:{opacity:0},
				delay:500
			})
		.addPage()
			.addComponent('caption',{text:'JS代码分布比例'})
			.addComponent('bar',{
				type:'bar',
				data:[
					['架构',.22,'red'],
