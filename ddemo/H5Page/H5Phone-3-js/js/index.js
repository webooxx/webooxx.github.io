...
var fx = function(fn, begin, end) {
    ...
    var options = arguments[3] || {}; // 第四个参数，如果有的话，则作为自定义配置
    var duration = options.duration || 500;
    var ease = options.ease || fx.ease.line;
    var delay = options.delay || 25;
...
fx.ease = {
  ...
  getByClass('outline__item_i_1')[0].onclick=function () {
    // document.body.scrollTop = 0;
    var s=0;
    fx( function(step){ document.body.scrollTop = step},document.body.scrollTop,s);
  }
  getByClass('outline__item_i_2')[0].onclick=function () {
    // document.body.scrollTop = 1*800-60;
    var s=1*800-60;
    fx( function(step){ document.body.scrollTop = step},document.body.scrollTop,s);
  }
  getByClass('outline__item_i_3')[0].onclick=function () {
    // document.body.scrollTop = 2*800-60;
    var s=2*800-60;
    fx( function(step){ document.body.scrollTop = step},document.body.scrollTop,s);
  }
  getByClass('outline__item_i_4')[0].onclick=function () {
    // document.body.scrollTop = 3*800-60;
    var s=3*800-60;
    fx( function(step){ document.body.scrollTop = step},document.body.scrollTop,s);
  }
  getByClass('outline__item_i_5')[0].onclick=function () {
